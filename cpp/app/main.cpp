...
namespace
{
    ...
    int readInt(const string &prompt)
    {
        ...
        while (true)
        {
            ...
            if (cin.eof())
            {
                throw runtime_error("Input stream closed while reading a number.");
            }
    ...
    string readLine(const string &prompt)
    {
        ...
        if (!getline(cin, input))
        {
            if (cin.eof())
            {
                throw runtime_error("Input stream closed while reading a line.");
            }

            cin.clear();
            throw runtime_error("Failed to read input line.");
        }
        return input;
    }
...
int main()
{
    ...
    {
        cout << "Input stream closed. Exiting. Output log saved to " << kOutputFile << "\n";
    }
